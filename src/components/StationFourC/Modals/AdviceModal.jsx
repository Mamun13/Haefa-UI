				...
				<form action="">
					...
					<div className="mb-3 input-shadow rounded-pill">
						<select id="Select" className="form-select input-padding rounded-pill select-form-padding">
							...
							<option>Lifestyle Modification</option>
							<option>Dietory Advice</option>
						</select>
					</div>
					<div className="mb-3 pb-0 m-0 input-shadow rounded-pill">
						<input type="text" id="" className="form-control input-padding rounded-pill py-2 border-0" placeholder="Other result" />
					</div>
